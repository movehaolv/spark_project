...
import com.lh.datamode.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
import com.lh.utils.{RanOpt, RandomDate, RandomNum, RandomOptions}
...
object MockerOffline {
  ...
  def main(args: Array[String]): Unit = {
    ...
    insertHive(spark, "sparkmall.city_info", cityInfoDF)
